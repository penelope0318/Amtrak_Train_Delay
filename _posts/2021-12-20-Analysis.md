...
## 0. Data Preparation
Here is the glimpse of the original dataset from <a href="https://www.kaggle.com/pranavbadami/nj-transit-amtrak-nec-performance?select=2018_11.csv">Kaggle</a>. We selected the data in 11/2019 and 12/2019, totalling 682,163 rows. As for data cleaning we dropped all rows with NA in scheduled_time, delay_minutes, from_id, to_id columns. Becides, in order to focus on the punctuality issue, we decides to drop all records that marked as 'cancelation', as it is a bit different from delay. 
